...
questions = [
    ...
    ("Which layer of the Earth is made mostly of rock?", "Core", "Crust", "Mantle", "Atmosphere", "Crust", "The Earth's crust is primarily made of rock and is the outermost layer of the planet. It includes both continental and oceanic crust which are involved in various geological processes like earthquakes and volcanic activity."),
    ...
    ("Which of the following is NOT a consequence of the Earth's tilt on its axis?", "Seasons", "Day and night", "Varying lengths of daylight", "Different weather patterns", "Day and night", "Earth's tilt on its axis causes seasons; it does not cause day and night. The tilt leads to variations in solar radiation received at different parts of the Earth during the year."),
    ...
    ("The boundary between the Earth's crust and mantle is known as the:", "Moho discontinuity", "Core-mantle boundary", "Lithosphere", "Asthenosphere", "Moho discontinuity", "The boundary between Earth's crust and mantle is known as the Moho discontinuity. This boundary marks a distinct change in seismic wave velocities which are used to study the interior of the Earth."),
    ("Which of these layers of the Earth is liquid?", "Inner core", "Outer core", "Mantle", "Crust", "Outer core", "The outer core of the Earth is liquid and is composed primarily of molten iron and nickel. This layer is crucial for generating Earth's magnetic field."),
...
data = [
    ...
    ("What is the average temperature on Mars?", "20°C", "-20°C", "0°C", "-60°C", "-60°C", "The average temperature on Mars is about -60 degrees Celsius. This extreme cold is due to its thin atmosphere and its distance from the Sun making it a hostile environment for life as we know it."),
    ...
    ("Mars has a very thin atmosphere which means that it:", "Has no weather patterns", "Has intense and frequent rainfalls", "Cannot support human life without assistance", "Is ideal for solar power generation", "Cannot support human life without assistance", "Mars has a very thin atmosphere which means that it cannot support human life without assistance. The thin atmosphere results in harsh surface conditions including high radiation levels and extreme temperatures.")
]
...
data_jupiter = [
    ...
    ("What is the approximate composition of Jupiter's atmosphere?", "90% hydrogen 10% helium", "50% hydrogen 50% helium", "70% nitrogen 30% oxygen", "80% methane 20% ammonia", "90% hydrogen 10% helium", "The approximate composition of Jupiter's atmosphere is 90% hydrogen and 10% helium. This combination contributes to its overall structure as a gas giant."),
    ...
    ("Jupiter’s magnetic field is:", "Slightly weaker than Earth's", "About the same as Earth's", "Much stronger than Earth's", "Non-existent", "Much stronger than Earth's", "Jupiter’s magnetic field is much stronger than Earth's contributing to its extensive magnetosphere that can trap charged particles and create intense radiation belts."),
    ("Io one of Jupiter’s moons is most known for its:", "Smooth icy surface", "Many volcanoes", "Thick atmosphere", "Rings", "Many volcanoes", "Io one of Jupiter’s moons is most known for its many volcanoes making it the most geologically active object in the solar system."),
